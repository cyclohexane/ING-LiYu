...
@IonicPage()
@Component({
  selector: 'page-pending-financial-fnc',
  templateUrl: 'pending-financial-fnc.html',
})
export class PendingFinancialFncPage {
  ...
  getFnc(scroll?) {
    ...
    this.http.doGet(`${url}?state=1&pageSize=30&pageNum=${this.page}`, res => {
      if (this.page === 1) {
