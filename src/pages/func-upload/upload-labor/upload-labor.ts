...
export class UploadLaborPage {
  ...
  readFile(imageURI) {
    ...
    //提示input is not a directory，而且官网说的是“Base FileSystem”？
    // this.file.readAsArrayBuffer(imageURI, this.decode(imageURI))
    //   .then(buffer => formData.append('upload_file', new Blob([buffer], { type: "image/jpeg" }), this.decode(imageURI)))
    //   .catch(e => {
    //     this.toaster.show("出现错误！");
    //     console.log(e);
    //   });
  }
